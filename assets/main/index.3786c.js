window.__require = function e(t, a, i) {
    ...
    AniTools: [function (e, t) {
        ...
        var a = {
            doLabStrAni: function (e, t, a) {
                ...
                var i = t.split(""), o = 0, n = a / i.length;
                ...
                if (void 0 === a && (a = 30), o = o || parseInt(e.string), t != o) {
                    ...
                    var n = 0, s = Math.abs(t - o), c = o > t ? -1 : 1;
                ...
                var s = cc.misc.degreesToRadians(t), c = cc.v2(Math.cos(s) * i, Math.sin(s) * i), r = i / o;
                ...
                var s = cc.misc.degreesToRadians(t), c = cc.v2(Math.cos(s) * a, Math.sin(s) * a), r = a / i,
                    h = o ? 0 : e.scale, l = n ? 0 : e.opacity;
                ...
                } else for (var m = this, d = 0, u = o - i + 1, g = function (e) {
        ...
        var a = {
            ...
            getAngle: function (e, t, a, i) {
                var o = Math.abs(e - a), n = Math.abs(t - i), s = n / Math.sqrt(Math.pow(o, 2) + Math.pow(n, 2)),
                    c = Math.acos(s), r = 180 / (Math.PI / c);
        ...
        t.exports = a, cc._RF.pop()
    }, {GameConfig: "GameConfig"}], HttpManagerJs: [function (e, t) {
        "use strict";
        var a;
        cc._RF.push(t, "197e1hfNnxIcJx73V3VhUxY", "HttpManagerJs");
        var i = e("GameConfig"), o = ((a = {
            ...
            this.cacheList.push({type: e, data: t, func: a, target: i}), this.isBusy || this.sendOne()
        }, a.sendOne = function () {
    ...
    }, {GameConfig: "GameConfig"}], LanguageSetJs: [function (e, t) {
        "use strict";
        ...
        var a = e("GameConfig"), i = e("GameUiTools"), o = e("MainManage"),
        ...
        e("../MainManage").endHttpShowInfo, cc.Class({
            ...
            properties: {
                ...
                starPre: cc.Prefab,
                lightPre: cc.Prefab,
                eatMusic: {default: null, type: cc.AudioClip},
                HurtMusic: {default: null, type: cc.AudioClip},
                failMusic: {default: null, type: cc.AudioClip}
            },
            ...
            getCreatePos: function (e, t) {
                void 0 === t && (t = 0);
                var a = e.width, i = e.height, o = s.getRandomNum(-a / 4, a / 4, !1),
                    n = s.getRandomNum(-i / 4, i / 4, !1), c = cc.v2(o + e.x, n + e.y),
            ...
            CreateLeaf: function (e, t) {
                for (var a = 0; a < e; a++) {
                    var i = cc.instantiate(this.leafPre), o = s.getRandomNum(1, 2, !0),
            ...
            CameraChangeZoomRatio: function (e, t) {
                if (e != t) {
                    ...
                    var i = !0;
                    t - e > 0 && (i = !1);
                    var o = Math.abs(t - e), n = Math.floor(o / .01);
            ...
            getEnemyPos: function (e, t) {
                if (void 0 === t && (t = 0), !this.gameOverFlags) {
                    var a = this.carmeraNode.getChildByName("MoveCamera").getComponent(cc.Camera).zoomRatio,
                        ...
                        o = Math.abs(i.x) - e.width - 400, n = Math.abs(i.y) - e.height - 400,
                        c = s.getRandomNum(-o, o, !1), r = s.getRandomNum(-n, n, !1), h = cc.v2();
            ...
            getEnemyID: function (e) {
                var t = s.getRandomNum(0, 100, !1), a = 0;
            ...
            CreateSingleEnemy: function (e, t) {
                if (!this.gameOverFlags) {
                    var a = this.enemyNode.children.length, i = this.playerNode.typeID;
                    if (i <= 3) {
                        if (a > 60) return
                    } else if (i >= 4 && i <= 5) {
                        if (a > 50) return
                    ...
                    for (var o = 0; o < e; o++) {
                        var n = this.getEnemyID(t), s = cc.instantiate(this.enemyPreArr[n]);
            ...
            enemyAction: function (e) {
                e.stopAllActions();
                var t = s.getRandomNum(500, 1e3, !0), a = e.position, i = s.getRandomNum(-t, t, !0),
                    o = s.getRandomNum(-t, t, !0), n = cc.v2(a.x + i, a.y + o),
                    c = this.enemyNode.convertToNodeSpaceAR(this.node.convertToWorldSpaceAR(n)),
                    r = Math.atan2(c.y - a.y, c.x - a.x), h = cc.misc.radiansToDegrees(r) - 90, l = e.speed,
                    m = s.pDistance(a, c) / l;
            ...
            EnemyReturnAction: function (e) {
                e.stopAllActions();
                var t = e.speed, a = s.getRandomNum(1e3, 1300, !1), i = a / t, o = Math.atan2(-e.y, -e.x),
            ...
            ChasePlayer: function (e) {
                e.stopAllActions();
                var t = e.position, a = this.playerNode.position, i = Math.atan2(a.y - t.y, a.x - t.x), o = e.speed,
                    n = this.carmeraNode.getChildByName("MoveCamera").getComponent(cc.Camera).zoomRatio,
                    c = s.getRandomNum(100 / n, 200 / n, !1), r = c / o, h = cc.misc.radiansToDegrees(i) - 90;
            ...
            EscapePlayer: function (e) {
                e.stopAllActions();
                var t = e.position, a = this.playerNode.position, i = Math.atan2(t.y - a.y, t.x - a.x), o = e.speed,
                    n = s.getRandomNum(100, 200, !1), c = n / o, r = cc.misc.radiansToDegrees(i) - 90;
            ...
            judgeIsChange: function (e) {
                ...
                if (this.tempArr.length >= 2) if (this.playerNode.typeID <= e) {
                    ...
                    for (var a = this.playerNode.getChildByName("son").convertToNodeSpaceAR(this.playerNode.convertToWorldSpaceAR(this.myFish.position)), i = function (e) {
                        var i = t.tempArr[e].position, o = s.pDistance(a, i) / 2e3;
            ...
            EatSmallAction2: function () {
                ...
                if (this.tempArr.length >= 3) {
                    var t = function () {
                        ...
                        var i = a.scaleX, o = a.scaleY, n = e.playerNode.getChildByName("son"),
            ...
            getSmallFishPos: function (e, t, a) {
                void 0 === a && (a = 0), a++;
                var i, o = cc.v2(), n = this.playerNode.getChildByName("son"),
                ...
                if (o = cc.v2(c.x + i * h, c.y + r * h), a > 100) {
                    var l = s.getRandomNum(.8, 1.3, !1), m = i * l, d = r * l;
            ...
            chooseBiggerFish: function () {
                if (!this.gameOverFlags) {
                    ...
                    var u = this.playerNode.position, g = s.pDistance(d, u) / 1e3;
            ...
            removeSomeBigFish: function () {
                if (!this.gameOverFlags) {
                    ...
                    for (var o = 0; o < a.length; o++) if (s.pDistance(e, a[o].position) > (this.gameHeight / 2 + a[o].height / 2) / t) return 8 == a[o].typeID && this.jingyuNum--, 9 == a[o].typeID && this.jiaoNum--, void this.enemyNode.removeChild(a[o])
                }
            },
            removeSmallFish222: function () {
                ...
                if (!this.gameOverFlags) {
                    var t = this.enemyNode.convertToNodeSpaceAR(this.node.convertToWorldSpaceAR(this.playerNode.position)),
                        a = this.carmeraNode.getChildByName("MoveCamera").getComponent(cc.Camera).zoomRatio, i = [];
            ...
            removeSmallFish: function () {
                if (!this.gameOverFlags) {
                    ...
                    if (a.length > 0) for (var n = 0; n < a.length; n++) if (s.pDistance(e, a[n].position) > (this.gameHeight / 2 + a[n].height / 2) / t) return Math.random(), this.enemyNode.removeChild(a[n]), void this.CreateSingleEnemy(1, this.playerNode.typeID)
                }
            },
            createLizi: function (e, t) {
                ...
                for (var n = this.carmeraNode.getChildByName("MoveCamera").getComponent(cc.Camera).zoomRatio, c = s.getRandomNum(15, 25, !0), r = s.getRandomNum(0, .05, !1), h = 0; h < c; h++) {
                    ...
                    var u = s.getRandomNum(.4 / n, 1.3 / n), g = 360 * Math.random(),
                        p = s.getCircumferencePos(a, l, g), f = s.pDistance(a, p) / s.getRandomNum(300, 500, !0);
                ...
                for (var y = s.getRandomNum(10, 20, !0), v = 0; v < y; v++) {
                    ...
                    var S = cc.instantiate(this.starPre), C = s.getRandomNum(1, 2, !0);
                    ...
                    var A = s.getRandomNum(.8 / n, 1.5 / n), x = 360 * Math.random(),
                        M = s.getCircumferencePos(a, N, x), P = s.pDistance(a, M) / s.getRandomNum(300, 500, !0),
            ...
            EatingEffectAction: function (e) {
                ...
                var o = e.position, n = this.liziNode.convertToNodeSpaceAR(this.enemyNode.convertToWorldSpaceAR(o));
            ...
            StoneFadeInAction: function () {
                var e = this.carmeraNode.getChildByName("MoveCamera").getComponent(cc.Camera).zoomRatio,
                    t = this.playerNode.position, a = cc.find("Canvas/RotLiziNode");
                ...
                for (var i = s.getRandomNum(50, 100, !1), o = Math.floor(i / 2), n = 0; n < i; n++) {
                    ...
                    var h = s.getRandomNum(50 / e, this.gameWidth / 2 / e, !1), l = 360 * Math.random(),
                        m = s.getCircumferencePos(t, h, l),
                        d = a.convertToNodeSpaceAR(this.node.convertToWorldSpaceAR(m)),
                        u = s.getRandomNum(1 / e, 2 / e, !1),
                        g = (s.getRandomNum(50, 100, !1), s.getRandomNum(180, 360, !1)), p = s.getRandomNum(.3, .6, !1),
                        f = a.convertToNodeSpaceAR(this.node.convertToWorldSpaceAR(t));
                    c.setPosition(f);
                    var y = cc.v2((f.x + d.x) / 2, (f.y + d.y) / 3 * 2), v = s.getRandomNum(.05, .2, !1),
                        N = s.getRandomNum(.4, .8, !1), S = [f, y, d];
                ...
                var C = this.stoneNode.getChildByName("stone1"), T = this.stoneNode.getChildByName("stone2"),
                ...
                this.stoneNode.runAction(cc.sequence(cc.delayTime(.15), cc.spawn(cc.scaleTo(.5, .8 * this.SizeScale, .8 * this.SizeScale).easing(cc.easeCircleActionInOut()), cc.callFunc(function () {
                    ...
                    var e = this, t = cc.instantiate(this.blackLayerPre);
            ...
            SummonDragonAction: function () {
                ...
                for (var t = this.playerNode.getChildByName("son"), a = t.convertToNodeSpaceAR(this.playerNode.convertToWorldSpaceAR(this.myFish.position)), i = 0; i < t.children.length; i++) {
                    var o = s.getRandomNum(50, 100, !1), n = Math.atan2(a.y - t.children[i].y, a.x - t.children[i].x),
            ...
            CreatePanLong: function () {
                ...
                var n = this.stoneNode.position, c = cc.v2(-50 * this.SizeScale, n.y - 400 * this.SizeScale),
                    r = cc.v2(-50 * this.SizeScale, c.y - this.gameHeight / 4);
                t.setPosition(r);
                var h = this, l = cc.instantiate(this.lightPre);
                this.node.addChild(l, 30), l.scaleX = 0, l.scaleY = 0, l.setPosition(this.stoneNode.position), t.runAction(cc.sequence(cc.spawn(cc.moveTo(.5, c), cc.fadeIn(.3), cc.callFunc(function () {
                    ...
                    var e = this, t = cc.instantiate(this.mainBtnPre);
                    ...
                    var t = e.stoneNode.getChildByName("stone1"), a = e.stoneNode.getChildByName("stone2"),
            ...
            BubbleAction: function () {
                if (!this.gameOverFlags) {
                    ...
                    var a = this.playerNode.angle + 90, i = cc.misc.degreesToRadians(a), o = s.getRandomNum(.5, 1, !1),
                        n = s.getRandomNum(50, 100, !1), c = s.getRandomNum(.2, .5, !1),
            ...
            on_touch_move: function (e) {
                if (!this.gameOverFlags && this.canMoveFlags) {
                    ...
                    var t = e.getLocation(), a = this.node.convertToNodeSpaceAR(t), i = this.carmeraNode.position,
            ...
            update: function (e) {
                if (this.updateCreate(), this.removeSmallFish(), this.removeSomeBigFish(), this.playerNode.typeID, this.waterCount++, this.waterCount > this.randnum && (this.WaterAction(), this.waterCount = 0, this.randnum = s.getRandomNum(20, 40, !0)), this.OffPos) {
                    if (this.gameOverFlags) return;
                    var t = cc.v2(0, 1).signAngle(this.OffPos), a = cc.misc.radiansToDegrees(t);
                ...
                if (this.lightFlags && (this.LightNumCount += e, this.LightNumCount >= this.lightjudeTime)) {
                    ...
                    var n = s.getRandomNum(.5, 1.5, !1), c = s.getRandomNum(.5, 1.5, !1);
        ...
        var a = e("HttpManagerJs"), i = e("LanguageSetJs"), o = e("GameConfig"), n = e("LoadSceneJs"),
            s = e("GameUiTools"), c = {
                gameHttpId: 0,
                subScoreHttp: null,
                gameNameText: null,
                ...
                getHttpGameId1: function () {
                    var e = window.location.href, t = e.substring(0, e.lastIndexOf("//") + 2), a = window.location.host,
                    ...
                    var o = document.URL, n = 0, s = o.substring(o.lastIndexOf("/game/") + 1, o.length).split("/");
                ...
                getHttpGameId: function () {
                    ...
                    var o = document.URL, n = o.lastIndexOf("/"), s = o.substring(0, n),
                ...
                getLinkGameReturn: function (e, t, a, i) {
                    if (console.log("err0", e), console.log("err1", t), console.log("err2", a), console.log("err3", i), 0 == e) {
                        ...
                        var s = o.launchScene, c = o.Bros, r = o.caS;
                ...
                ranRecGameData: function () {
                    if (null != this.recGameData && "" != this.recGameData) {
                        this.returnBool = !1;
                        var e = this.recGameData.length, t = o.returnRanNum(1, e) - 1;
                ...
                ranLinkUrl: function () {
                    if (null != this.ranLinkData && this.ranLinkData.gameList && null != this.ranLinkData.gameList) {
                        var e = this.ranLinkData.gameList.length, t = o.returnRanNum(1, e) - 1;
        ...
        var a = {
            ...
            name_1: {CN: "\u874c\u86aa", CHT: "\u874c\u86aa", EN: "Tadpole", KOR: "\uc62c\ucc59\uc774"},
            name_2: {CN: "\u9752\u86d9", CHT: "\u9752\u86d9", EN: "Frog", KOR: "\uac1c\uad6c\ub9ac"},
            name_3: {CN: "\u4e4c\u9f9f", CHT: "\u70cf\u9f9c", EN: "Tortoise", KOR: "\uac70\ubd81\uc774"},
            name_4: {
                CN: "\u5c0f\u91d1\u9c7c ",
                CHT: "\u5c0f\u91d1\u9b5a",
                EN: "Goldfish",
            ...
            name_5: {CN: "\u9526\u9ca4\u9c7c", CHT: "\u9326\u9bc9\u9b5a", EN: "Koi Fish", KOR: "\uc789\uc5b4"},
            name_6: {CN: "\u7535\u9cd7", CHT: "\u96fb\u9c3b", EN: "Eel", KOR: "\uc804\uae30\ubc40\uc7a5\uc5b4"},
            name_7: {CN: "\u9ca8\u9c7c", CHT: "\u9bca\u9b5a", EN: "Shark", KOR: "\uc0c1\uc5b4."},
            name_8: {CN: "\u5927\u9cb8\u9c7c", CHT: "\u5927\u9be8\u9b5a", EN: "Whale", KOR: "\ud070 \uace0\ub798"},
            name_9: {CN: "\u86df", CHT: "\u86df", EN: "Snake", KOR: "\ud65c\uc6a9\ub2e8\uc5b4\ucc38\uc870"},
            name_10: {CN: "\u795e\u9f99", CHT: "\u795e\u9f8d", EN: "Dragon", KOR: "\uc2e0\ub8e1"},
        ...
        var a = {
            PoolDic: {bulletPool: null}, addPoolObj: function (e, t) {
        ...
        var a = {
            ...
            getDiscForNode: function (e, t) {
                var a = this.getToWorldPosAR(e), i = this.getToWorldPosAR(t);
            ...
            writeJson: function (e, t) {
                if (cc.sys.isBrowser) {
                    console.log("\u6d4f\u89c8\u5668");
                    var a = new Blob([e], {type: "application/json"}), i = document.createElement("a");
        ...
        var a = {
            bgAudio: null, isPlayAudio: !0, isPlayBG: !0, playBG: function (e, t) {
                ...
                var t;
                if (null != ToolsJs.AudioClipDic[e]) t = ToolsJs.AudioClipDic[e]; else {
    ...
    }, {GameConfig: "GameConfig"}], enemyJS: [function (e, t) {
        "use strict";
        ...
        var a = e("GameUiTools"), i = e("GameConfig"), o = e("MainManage");
        cc.Class({
            extends: cc.Component,
            properties: {
                bgLayer: cc.Node,
            ...
            onLoad: function () {
                ...
                var o = this.mainSelf.maxTypeID, n = this.getHighScore();
            ...
            getContentByScore: function (e, t) {
                var a = "\u6211\u771f\u662f\u592a\u5389\u5bb3\uff0c\u5728" + t + "\u4e2d\u7adf\u7136\u5f97\u4e860\u5206\uff0c\u5168\u7403\u53ea\u67091\u4e2a\u4eba\u5f970\u5206\uff01",
                    i = parseInt(.3 * this.standardScore), o = parseInt(.5 * this.standardScore),
                    n = parseInt(.7 * this.standardScore), s = parseInt(.9 * this.standardScore), c = this.endPercent;
            ...
            getContentByScore4_1: function (e) {
                var t = "\ub09c \uc815\ub9d0 \ub300\ub2e8 \ud574, \uac8c\uc784 \uc5d0\uc11c \ubb34\ub824 0 \uc810 \uc744 \ubc1b \uc558 \uc2b5 \ub2c8 \ub2e4. \uc804 \uc138\uacc4 \uc5d0\uc11c 1 \uba85 \ub9cc 0 \uc810 \uc744 \ubc1b \uc558 \uc2b5 \ub2c8 \ub2e4!",
                    a = parseInt(.3 * this.standardScore), i = parseInt(.5 * this.standardScore),
                    o = parseInt(.7 * this.standardScore), n = parseInt(.9 * this.standardScore), s = this.endPercent;
    ...
    }, {GameConfig: "GameConfig", GameUiTools: "GameUiTools", MainManage: "MainManage"}], jianceJS: [function (e, t) {
        "use strict";
    ...
    }, {"../commonJs/mTool_WHQ": "mTool_WHQ"}], linkHttpIconJs: [function (e, t) {
        "use strict";
        ...
        e("GameConfig"), cc.Class({
            extends: cc.Component, properties: {iconSpr: cc.Node, iconSpr1: cc.Node}, onLoad: function () {
                if (this._imageArr = [], this.stopUpdateBool = !0, this.gameWidth = cc.winSize.width, this.gameHeight = cc.winSize.height, null != a.recGameData && "" != a.recGameData && null != a.recGameimg1 && "" != a.recGameimg1) {
                    ...
                    var i = a.recGameimg1, o = a.recGameimg2, n = this.iconSpr, s = this.iconSpr1, c = this;
    ...
    }, {GameConfig: "GameConfig", MainManage: "MainManage"}], loadTools: [function (e, t) {
        "use strict";
        ...
        var a = {
            getRandomNum: function (e, t, a) {
                ...
                var s = a + (e.x - t / 2 + .5) * o, c = i + (e.y + .5) * n;
                return cc.v2(s, c)
            }, worldPosToCbPos: function (e, t, a, i, o, n) {
                var s = (e.x - a) / o - .5 + t / 2, c = (e.y - i) / n - .5;
                ...
                if (Math.abs(e.x) + Math.abs(e.y) !== 0) {
                    var t = cc.v2(1, 0), a = e.signAngle(t);
        ...
        cc._RF.push(t, "132743iYdROWry4PeEjE8Fb", "rockerJS"), cc.Class({
            ...
            onLoad: function () {
                ...
                this.dir = cc.v2(0, 0), this.buttonNode.setPosition(e), this.mainSelf.node.on(cc.Node.EventType.TOUCH_END, function () {
                    ...
                    var t = e.getLocation(), a = this.node.convertToNodeSpaceAR(t), i = a.mag();
                    ...
                    var t = e.getLocation(), a = this.mainSelf.node.convertToNodeSpaceAR(t);
        ...
        var a = e("MainManage"), i = (e("LoadSceneJs"), e("GameConfig"));
        cc.Class({
            extends: cc.Component, properties: {showInfoT: cc.Label, startT: cc.Label}, onLoad: function () {
